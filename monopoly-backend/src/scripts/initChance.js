  ...
  try {
    ...
    const chanceData = [
      ...
      { title: '下下签', description: '隔壁店铺着火，导致自己的店铺客源减少，损失400文', payAmount: 400 },
        ...
        { title: '上上签', description: '赢得猜灯谜比赛获得奖励200文', payAmount: -200 },
        ...
        { title: '上上签', description: '创作诗文得到贵人赏赐获得800文', payAmount: -800 },
        ...
        { title: '下下签', description: '骑马时不小心撞到行人，赔偿200文', payAmount: 200 },
