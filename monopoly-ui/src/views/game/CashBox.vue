    ...
    methods:{
        ...
        selectBox(denomination,currentIndex,isUnSelect=false,maxIndex,boxName){
            ...
            if(denomination===2000 || denomination===5000){
                ...
                console.log(`selectBox 被拦截: denomination=${denomination}, currentIndex=${currentIndex}, maxIndex=${maxIndex}`);
                return;
            }
        ...
        payFrom(from,callback){
            ...
            if(cashes && cashes.length>0){
                ...
                const pos = getRelativePosition(cash,this.$refs[toBox])
                console.log("pos:",pos);
                ...
                this.$refs[toBox].appendChild(cash);
                this.$nextTick(()=>{
                    //算出新的位置
                    let newPos = {};
                    if("other"===from){
